...
class Croccante_Admin {
	...
	public function enqueue_admin_scripts() {
		...
		wp_enqueue_script( 'croccante-admin-panel', get_template_directory_uri() . '/inc/admin/admin-panel.js', array('jquery', 'jquery'), '1.0', true );
	}
	/**
	 * Add admin notice.
	 */
		...
		<div class="cresta-theme-info">
			...
			<div class="welcome-description-wrap">
				...
				<p class="cresta-actions">
					...
					<a href="<?php echo esc_url( apply_filters( 'croccante_pro_theme_url', 'http://crestaproject.com/demo/croccante/' ) ); ?>" class="button button-secondary docs" target="_blank"><?php esc_html_e( 'View Demo', 'croccante' ); ?></a>
					
					<a href="<?php echo esc_url( apply_filters( 'croccante_pro_theme_url', 'http://crestaproject.com/demo/croccante-pro/' ) ); ?>" class="button button-primary docs" target="_blank"><?php esc_html_e( 'View PRO version Demo', 'croccante' ); ?></a>
				...
				<tbody>
					...
					<tr>
						...
						<td class="btn-wrapper">
							<a href="<?php echo esc_url( apply_filters( 'croccante_pro_theme_url', 'http://crestaproject.com/demo/croccante-pro/' ) ); ?>" class="button button-secondary" target="_blank"><?php esc_html_e( 'View PRO version demo', 'croccante' ); ?></a>
